...
const Dropdown = ({handleCheckboxChange, checkedNewPro, setCheckedNewPro, setCheckedRunPro,checkedRunPro}) => {
  ...
  const handleNewProChange = (event) => {
    setCheckedNewPro(event.target.checked);
  };
  const handleRunProChange = (event) => {
    setCheckedRunPro(event.target.checked);
  };
